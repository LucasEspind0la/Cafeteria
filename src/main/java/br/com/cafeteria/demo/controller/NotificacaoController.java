...
public class NotificacaoController {
    ...
    // GET /api/notificacoes/{email} → Listar todas
    @GetMapping("/{email}")
    ...
    // GET /api/notificacoes/{email}/nao-lidas → Contar não lidas
    ...
    // POST /api/notificacoes/enviar → Enviar notificação manual (admin)
    @PostMapping("/enviar")
